 ...
 * Refrence:https://learn.microsoft.com/en-us/dotnet/csharp/language-reference/statements/iteration-
statements
 */
...
namespace COMP003A.LectureActivity4
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            // count 0-9
            int limit = 10; // varibale limit for the loop
            /*
             * The for statemnt: executes its body while a specified Boolean expression
            evaluates to true.
            ...
            */
            ...
            } while (counter2 < 10); //loop unitl counter2 is equal to 10 or greater
            ...
            // 1. loop varibale 'i' is set 1 instead of 0
